...
train['year'] = (train['year'] - train['year'].mean()) / train['year'].std()^^J
    ...
    \begin{frame}{Model selection and evaluation: Summary}
        \begin{itemize}
            \item Whenever a choice is made on the basis of performance in a dataset, \textbf{we have to assume the performance of the chosen model is going to be inflated}
