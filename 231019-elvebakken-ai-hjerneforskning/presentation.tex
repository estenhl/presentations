...
\defbeamertemplate*{footline}{glio}{%
  \leavevmode%
  \hbox{%
  \begin{beamercolorbox}[wd=\paperwidth,ht=2.25ex,dp=1ex,center]{footer}%
	\href{https://link.springer.com/article/10.1007/s40747-022-00815-5}{Deep learning based brain tumor segmentation: a survey, Liu, Zhihua, et al., \textit{Complex \& Intelligent Systems}, 2022.}
  \end{beamercolorbox}%
  }%
  \vskip0pt%
}
...
\defbeamertemplate*{footline}{cole}{%
  ...
  \hbox{%
  \begin{beamercolorbox}[wd=\paperwidth,ht=2.25ex,dp=1ex,center]{footer}%
	\href{https://pubmed.ncbi.nlm.nih.gov/29892055/}{Brain age and other bodily 'ages': implications for neuropsychiatry, Cole, James H., et al., \textit{Molecular Psychiatry}, 2019.}
  \end{beamercolorbox}%
  }%
  \vskip0pt%
}

\defbeamertemplate*{footline}{synth}{%
  \leavevmode%
  \hbox{%
  \begin{beamercolorbox}[wd=\paperwidth,ht=2.25ex,dp=1ex,center]{footer}%
	\href{https://pubmed.ncbi.nlm.nih.gov/34311421/}{Learning to synthesise the ageing brain without longitudinal data, Xia, Tian, et al., \textit{Medical Image Analysis}, 2021.}
  \end{beamercolorbox}%
  }%
  \vskip0pt%
}
...
\begin{document}
	...
	\setbeamertemplate{footline}[glio]
	...
	\setbeamertemplate{footline}[synth]
	...
	\begin{frame}{AI og forskningsetikk: Vil vi vite?}
		...
		\begin{tikzpicture}
			\node[inner sep=0pt, draw=black] {
				\includegraphics[width=11cm]{data/nrk.png}
			};
		\end{tikzpicture}
	\end{frame}
