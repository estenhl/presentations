...
\begin{document}
	...
	\begin{frame}{Plan for dagen}
		\begin{enumerate}
			...
			\begin{itemize}
				...
				\item Intuisjon bak språkmodeller
			\end{itemize}
	...
	% 	Hvordan bidrar kunstig intelligens til hjerneforskning?
	% 	\begin{itemize}
	% 		\item Maskinlæring bidrar til å supplere teoriutvikling gjort av mennesker med data-dreven hypotese-generering.
	% 	\end{itemize}
	% \end{frame}
	...
	% 	\begin{itemize}
	% 		\item ML er avhengig av store mengder data. Dette kan gjøre det vanskelig å leve opp til prinsippet om dataminimering, som tilsier at det ikke skal samles flere personopplysninger enn nødvendig.
	% 		\item Deling av trente maskinlæringsmodeller
	% 	\end{itemize}
	% \end{frame}

	% \begin{frame}{AI og forskningsetikk: Tolkning}
	% 	Hvordan ivareta hensynet til enkeltpersoner når vi bruker data til å trene maskinlæringsmodeller i forskningsøyemed?
	% 	\begin{itemize}
	% 		\item ML er avhengig av store mengder data. Dette kan gjøre det vanskelig å leve opp til prinsippet om dataminimering, som tilsier at det ikke skal samles flere personopplysninger enn nødvendig.
	% 		\item Det er vanlig praksis å dele trente modeller.
	% 	\end{itemize}
	% \end{frame}
