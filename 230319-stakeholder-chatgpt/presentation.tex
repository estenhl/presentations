...
\begin{document}
	...
	\begin{frame}{Emergens} % Coding
		...
		\href{https://twitter.com/i/status/1636477569565335553}{Making arcade games}
	\end{frame}

	\begin{frame}{Chatbotter} % Angry
		\centering
		\begin{tikzpicture}
			\node[] at (-2.7, -3.7) {
	...
	\begin{frame}{Chatbotter} % Marriage
		\centering
		\begin{tikzpicture}
			\node[] at (0, -0.8) {
	...
	\begin{frame}{Chatbotter} % Existential
		\centering
		\begin{tikzpicture}
			\node[] at (2.7, -3.7) {
