    ...
    \begin{tikzpicture}
        ...
        \visible<2>{
            \node[text width=10.5cm] at (0, 0) {
                \begin{itemize}
                \item[] Principal component analysis: Enforces no linear correlation between components
                \item[] Independent component analysis: Maximizes statistical independence between signals
                \end{itemize}
            };
        }
        \visible<3>{
...
\begin{frame}{Dimensionality reduction: Partial least squares}
    \begin{tikzpicture}
        ...
        \visible<2>{
            ...
            \node[] at (0, -3) {
                $v \rightarrow$ direction of greatest covariance between $X$ and $Y$
            };
        }
    \end{tikzpicture}
\end{frame}
