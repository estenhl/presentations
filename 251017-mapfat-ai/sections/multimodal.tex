...
\begin{frame}{Early fusion: blending information from the start}
    \begin{tikzpicture}
        ...
        \only<4>{
            \node[inner sep=0pt, draw=black] at (0, 0) {
                \includegraphics[width=11cm]{data/sun.png}
            };
        }
        \only<5>{
            \node[inner sep=0pt, draw=black] at (0, 0) {
...
\begin{frame}{Intermediate fusion: integrating insights along the way}
    \begin{tikzpicture}
        ...
        \only<2>{
            \node[inner sep=0pt, draw=black] at (0, 0) {
                \includegraphics[width=11cm]{data/zhang_et_al.png}
            };
        }
        \only<3>{
            \node[inner sep=0pt, draw=black, label=above:{Clinical notes}] at (0, -2.75) {
                \includegraphics[width=7cm]{data/zhang_notes.png}
            };
            \node[inner sep=0pt, draw=black, label=above:{Multimodal MRI}] at (0, -0.5) {
        ...
        \only<4>{
            \node[inner sep=0pt, draw=black] at (0, 0) {
                \includegraphics[width=11cm]{data/zhang_model.png}
            };
        }
        \only<5>{
            \node[inner sep=0pt, draw=black] at (0, 0) {
