        ...
        \visible<8>{
            \node[text width=10cm] at (0, 0) {
                ...
                \begin{itemize}
                    ...
                    \item However, it can be shown that functions generally calm down as they become more complex after having perfectly fitted the training data
                    \item \textbf{Only works for some types of models}
                \end{itemize}
            };
        }
    \end{tikzpicture}
