...
\begin{frame}{Computer vision: Background}
    \centering
    \begin{tikzpicture}
        \visible<1-2>{
...
\begin{frame}{Computer vision: Image data}
    \begin{tikzpicture}
        \node[] at (-5.25, 3.5) {};
        \node[] at (5.25, -3.5) {};
...
\begin{frame}{Computer vision: Transfer learning}
    \centering
    \resizebox{\textwidth}{!}{
        \begin{tikzpicture}
            \visible<1-5>{
...
\begin{frame}{Computer vision: Data augmentation}
    \centering
    \begin{tikzpicture}
    \visible<1-3>{
...
\begin{frame}{Computer vision: Tutorial}
    \centering
