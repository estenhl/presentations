...
\begin{document}
	...
	\begin{frame}[t]{Perception of AI: Positivism}
		...
		\begin{itemize}
			\item A study among a representative sample in the Netherlands asked participants to rate usefulness, fairness, and risk of AI (vs. human) decision-making the media, health sector, and justice system.
	...
	\setbeamertemplate{footline}[decisiontype]

	\begin{frame}[t]{Perception of AI: Types of decisions}
		\textbf{Perception of AI decisions may depend on type of decision (Lee, 2018)}
		\begin{itemize}
			\item Participants perceived human vs. AI to be fairer and more trustworthy on hiring decisions and employee performance evaluation (but not on work scheduling/assignment decisions)
			\item Participants reacted more negatively to AI vs. human hiring decisions and employee performance evaluations (no difference on work scheduling/assignment decisions)
		\end{itemize}
	\end{frame}
	...
	\begin{frame}[t]{Perception of AI: Man vs machine}
		\textbf{More moral outrage when humans are discriminatory compared to AI (Bigman et al., 2023)}
		\begin{itemize}
			\item Participants were asked to assess degree of discrimination, objectivity, prejudice and moral outrage after reading about a discriminatory hiring process. The discrimination was performed either by an AI or a human (HR specialist).
