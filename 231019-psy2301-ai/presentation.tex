...
\begin{document}
	...
	% \begin{frame}{Decision making: Biases}
	% \end{frame}

	% \section{Decision support}

	% \begin{frame}{Decision support: Personalization}
	% \end{frame}

	% \begin{frame}{Decision support: Prioritization}
	% \end{frame}

	% \begin{frame}{Decision support: Automation}
	% \end{frame}

	% \begin{frame}{Decision support: Optimization}
	% \end{frame}

	% \begin{frame}{Decision support: Synthesis}
	% \end{frame}

	% \begin{frame}{Decision support: High stakes?}
	% \end{frame}

	% \begin{frame}{Decision support: Black box problems}
	% \end{frame}

	% \begin{frame}{Decision support: Explainability}
	% \end{frame}

	% \begin{frame}{Decision support: Knowledge}
	% \end{frame}

	% \begin{frame}{Decision support: Antropomorphization}
	% \end{frame}
