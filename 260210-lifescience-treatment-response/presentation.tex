...
\begin{document}
    ...
    \begin{frame}{Explainable artificial intelligence}
        \begin{tikzpicture}
            ...
            \mriside{-5.9}{0}{1.5cm}{data/slice_110.png}

            \node[anchor=east, align=left, font=\small] (output) at (7.1, 0) {Eligible for\\treatment?};
            ...
            \only<2>{
                \draw[] (input.east) -- ($ (input.east) + (2.5, 0) $);
                \draw[] (output.west) -- ($ (output.west) + (-2.5, 0) $);
                \cnn{-2.8}{0}{0.14}{0.21}{baba-green}{1}
            }
