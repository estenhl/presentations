...
\subtitle{Image recognition in Python with Tensorflow}
...
\titlegraphic{
	...
	\hspace{\logosep}
	\includegraphics[height=\logoheight]{data/epimed.png}
	\hspace{\logosep}
	\includegraphics[height=\logoheight]{data/bio.png}
}
...
\begin{document}
	...
	\begin{frame}{Introduction} % Learning goals
		\vfill
		Theory session ($\sim$1 hour):
		\begin{itemize}
			\item What is a statistical learning model?
			\item What is a loss function?
			\item How do we train a model?
			\item How does a deep neural network work?
			\item How does a convolutional neural network process images?
			\item What is transfer learning?
			\item What is overfitting, and how do we avoid it?
		\end{itemize}
		Practical session ($\sim$2 hours):
		\begin{enumerate}
			\item Configure a Python-environment containing Tensorflow
			\item Set up a pretrained convolutional neural network for prediction
	...
	\begin{frame}{Introduction} % Motivation: Nina
		\centering
		\vfill
		\begin{tikzpicture}
			\node[inner sep=0pt, draw=black, label=Bear] at (0, 0) {
				\includegraphics[height=3cm]{data/bear.jpeg}
			};
			\node[inner sep=0pt, draw=black, label=Moose] at (4, 0) {
				\includegraphics[height=3cm]{data/moose.jpeg}
			};
			\node[inner sep=0pt, draw=black, label=below:Bobcat] at (2, -3.5) {
				\includegraphics[height=3cm]{data/bobcat.jpeg}
			};
		\end{tikzpicture}
		\vfill
	\end{frame}
	...
	\begin{frame}{Introduction} % Motivation: Brain classification
		...
		\begin{tikzpicture}
			\node[] at (0, 0) {
				\includegraphics[width=1.5cm]{data/control_1.png}
			};
			\node[] at (1.25, -2) {
				\includegraphics[width=1.5cm]{data/patient_3.png}
			};
			\node[] at (2.7, 0) {
				\includegraphics[width=1.5cm]{data/control_4.png}
			};
			\node[] at (4.9, 0) {
				\includegraphics[width=1.5cm]{data/patient_0.png}
			};
			\node[] at (6.9, 0) {
				\includegraphics[width=1.5cm]{data/patient_1.png}
			};
			\node[] at (8.15, -2) {
				\includegraphics[width=1.5cm]{data/patient_2.png}
			};

			\draw[<->] (-1.2, -1) -- (9.35, -1);
			\node[anchor=north] at (4.075, -1) {Age};
			\node[anchor=north] at (0, -1.1) {\small{15}};
			\node[anchor=south] at (1.25, -0.9) {\small{22}};
			\node[anchor=north] at (2.7, -1.1) {\small{31}};
			\node[anchor=north] at (4.9, -1.1) {\small{42}};
			\node[anchor=north] at (6.9, -1.1) {\small{55}};
			\node[anchor=south] at (8.15, -0.9) {\small{60}};

			\draw[] (0, -0.95) -- (0, -1.05);
			\draw[] (1.25, -0.95) -- (1.25, -1.05);
			\draw[] (2.7, -0.95) -- (2.7, -1.05);
			\draw[] (4.9, -0.95) -- (4.9, -1.05);
			\draw[] (6.9, -0.95) -- (6.9, -1.05);
			\draw[] (8.15, -0.95) -- (8.15, -1.05);
	...
	\begin{frame}{Statistical learning: Training} % Demo
		\vfill
		\centering
		\Large{Demo}
		\vfill
	...
	\begin{frame}{Practicalities: Regularization} % Regularized vs normal
		\vfill
		\centering
		\begin{tikzpicture}
			\begin{axis}[
	...
	\begin{frame}{Practicalities: Regularization} % Dropout
		\centering
		\vfill
		\begin{tikzpicture}
			\node[
	...
	\begin{frame}{Practicalities: Augmentation}
		\centering
		\vfill
		\begin{tikzpicture}
			\node[] at (-1, 1.8) {};
			...
			\node[] (p1) at (0, 0) {
				\includegraphics[width=2cm]{data/flower.jpg}
			};
	...
	\begin{frame}{Practicalities: Augmentation}
		...
		\begin{tikzpicture}
			...
			\node[label=below:\textcolor{green}{\huge{\cmark}}] (p2) at (2.8, 0) {
				\includegraphics[width=2cm]{data/reversed.jpg}
			};

			\draw[-latex,line width=1mm] (p1) -- (p2);
		\end{tikzpicture}
		\vfill
	\end{frame}
	...
	\begin{frame}{Practicalities: Augmentation}
		...
		\begin{tikzpicture}
			...
			\node[label=below:\textcolor{green}{\huge{\cmark}}] (p3) at (5.6, 0) {
				\includegraphics[width=2cm]{data/zoomed.jpg}
			};

			\draw[-latex,line width=1mm] (p1) -- (p2);
			\draw[-latex,line width=1mm] (p2) -- (p3);
		\end{tikzpicture}
		\vfill
	\end{frame}
	...
	\begin{frame}{Practicalities: Augmentation}
		...
		\begin{tikzpicture}
			...
			\node[label=below:\textcolor{red}{\huge{\xmark}}] (p4) at (8.4, 0) {
				\includegraphics[width=2cm]{data/colors.jpg}
			};

			\draw[-latex,line width=1mm] (p1) -- (p2);
			\draw[-latex,line width=1mm] (p2) -- (p3);
			\draw[-latex,line width=1mm] (p3) -- (p4);
		\end{tikzpicture}
		\vfill
	\end{frame}
