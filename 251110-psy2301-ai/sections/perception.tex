\section{How are decisions made by AIs perceived?}
	...
	\begin{frame}[t]{Perception of AI: Skepticism}
		...
		\begin{itemize}
			...
			\item <2> AI is seen as having less agency and experience, and thus are \textbf{less able to make moral decisions}, even when they coincide with humans (Bigman \& Gray, 2018).
		\end{itemize}
		\vspace{-2.5cm}
		\centering
		...
		\begin{tikzpicture}
			\visible<1>{
				...
				\node[font=\tiny\selectfont, anchor=south] at (0, -3.62) {
	...
	\begin{frame}[t]{Perception of AI: Positivism}
		...
		\begin{itemize}
			\item For high-stake decisions, participants perceived decisions by AI (vs. human) to be slightly more useful, fairer and less risky in high-stake domains (typically health and justice), with no differences concering low-stakes decisions.
			\item Perceived usefulness increased with knowledge on AI, programming, and algorithms (self-reported).
		...
		\begin{tikzpicture}
			\node[font=\tiny] at (0, 0) {
				\href{https://link.springer.com/article/10.1007/s00146-019-00931-w}{In AI we trust? Perceptions about automated decision-making by artificial intelligence}, Araujo, T. et al., \textit{AI \& society}, 2020
			};
		\end{tikzpicture}
	\end{frame}
	...
	\begin{frame}{Practice questions}
		...
		Group work
		\begin{itemize}
			\item What kind of decisions would you be comfortable with AI making on your behalf?
			\item What would it take to change your view?
		\end{itemize}
	\end{frame}
