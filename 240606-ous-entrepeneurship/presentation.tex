...
\begin{document}
    ...
    \begin{frame}{Background}
        ...
        \begin{tikzpicture}
                ...
                \onslide<10->{
                    ...
                    \only<10>{
                        \node[anchor=west, align=left, font=\descriptionsize\linespread{0.8}\selectfont, text depth=0] at (medtech.east) {
                            ...
                            Founder, chairman of the board, consultant
                        };
                    }
                }
                \onslide<12->{
            ...
            \only<8>{
                \node[inner sep=0pt, draw=black] at (5, -3.5) {
                    \includegraphics[width=6cm]{data/huddly.png}
                };
            }
        \end{tikzpicture}
    \end{frame}
    ...
    \begin{frame}{Things to keep in mind: Market validation}
        \begin{tikzpicture}
            \node[] at (0, 0) {};
            \node[] at (10, -7) {};
    ...
    \begin{frame}{Things to keep in mind: Advisors}
        \begin{tikzpicture}
            \node[] at (0, 0) {};
            \node[] at (10, -7) {};
            ...
            \stickman{(8, -1)}{gray}
            \stickman{(8.8, -1.5)}{gray}
            \node[anchor=west, align=left] at (7.8, -3.7) {
                Experience\\
                Network
            };
        \end{tikzpicture}
