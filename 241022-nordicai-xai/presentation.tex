...
\subtitle{Detecting patterns of abnormal brain aging in patients with neuropsychiatric disorders}
\date{22.10.2024}
...
\begin{document}
    ...
    \begin{frame}{Brain age: Motivation}
        \begin{tikzpicture}
            ...
            %         minimum size=0.05cm,
            %         inner sep=0pt,
            %     ] at ($ (side.north east) - (1.06, 0.84) $) {};
            %     \draw[red] ($ (side.north east) - (1.085, 0.84) $) --
            %                ($ (side.north east) - (1, -0.7) $);
            %     \draw[red] ($ (side.north east) - (1.06, 0.865) $) --
            %                ($ (side.north east) - (-0.45, 1.01) $);
            % }
            % \visible<5>{
            %     \node[
            %         draw=red,
            ...
            %     \pgfplotsforeachungrouped  \i in {0,...,14} {
            %         \pgfplotsforeachungrouped  \j in {0,...,14} {
            %             \ifdim\i pt<\j pt
    ...
    \begin{frame}{Explainable artificial intelligence: Background}
        \begin{tikzpicture}
    ...
    \begin{frame}{Explainable artificial intelligence: Results}
        ...
        \begin{tikzpicture}
            ...
            \visible<4>{
                \averageheatmap{-2.7}{2.5}{ADHD}{{\shortstack{Attention deficit \\[-0.05cm] hyperactivity disorder}}}
                \averageheatmap{0.3}{2.5}{ANX}{{\shortstack{Anxiety \\[-0.112cm] disorder}}}
                \averageheatmap{3.3}{2.5}{ASD}{{\shortstack{Autism spectrum \\[-0.112cm] disorder}}}
                \averageheatmap{-2.7}{-2.5}{MDD}{{\shortstack{Major depressive \\[-0.112cm] disorder}}}
                \averageheatmap{3.3}{-2.5}{MCI}{{\shortstack{Mild cognitive \\[-0.112cm] impairment}}}
            }
            \visible<4-7>{
            ...
            \visible<6-7>{
                \node[anchor=west] (demba) at ($ (DEM.east) + (0.2, 0) $){
                    0.75
                };
                \node[anchor=south, font=\scriptsize] (ba) at ($ (demba.north) - (0, 0.1) $) {
                    \underline{Brain age}
                };
                \node[anchor=west] (demhm) at ($ (demba.east) + (0.7, 0) $) {
                    0.81
                };
                \node[anchor=south, font=\scriptsize] (hm) at ($ (demhm.north) - (0, 0.1) $) {
                    \underline{Heatmap}
                };
                \node[] (auc) at ($ (ba)!0.5!(hm) + (0, 0.5) $) {
                    AUC
                };
            ...
            \visible<7>{
                \draw[->, red] (demba) -- (demhm) node [midway, below, red, font=\footnotesize\selectfont] {0.06};
                \draw[->, red] (msba) -- (mshm) node [midway, below, red, font=\footnotesize\selectfont] {0.24};;
            }
            \visible<4,8-10>{
            ...
            \visible<9-10>{
                ...
                \draw[stealth-stealth, very thick, gray] (BIPcontrols) -- (BIP) node[midway, right] {AUC=0.60};
                \draw[stealth-stealth, very thick, gray] (SCZcontrols) -- (SCZ) node[midway, right] {AUC=0.65};
            }
            \visible<10>{
                \draw[stealth-stealth, red] (BIP) -- (SCZ) node[midway, above, red] {AUC=0.5};
            }
        \end{tikzpicture}
    \end{frame}
