...
\begin{document}
    ...
    \newcommand{\cnnarrow}[3]{
        \begin{scope}[transparency group, opacity=0.5]
            \draw[-stealth, line width=2pt, #3] #1 to [in=180, out=0] #2;
        \end{scope}
    }
    ...
    \newcommand{\cnnbox}[1]{
        ...
        \begin{tikzpicture}
            ...
            \ifnum#1<2
                ...
                \cnn{0}{0}{0.066}{0.15}{blue}{1}

                \cnnarrow{($ (output.west) - (0.39, 0) $)}{($ (output.west) + (0.1, 0) $)}{blue}
            \fi

            \ifnum#1=2
                \segmentationtop{-1.4}{0}
    ...
    \newcommand{\mathplot}[1]{
        \begin{tikzpicture}
            ...
            \ifnum#1=0
                \artificialneuron{-0.5}{1}{$n_{00}$}{n00}{blue!65}
                \artificialneuron{-0.5}{0.5}{$n_{01}$}{n01}{blue!55}
                \artificialneuron{-0.5}{0}{$n_{02}$}{n02}{blue!98}

                \artificialneuron{0.5}{0.5}{$n_{10}$}{n10}{blue!82}

                \connection{(n00)}{(n10)}{blue!45}{node [midway, above, font=\tiny\selectfont, text=black, yshift=-0.05cm] {$w_0$}}
                \connection{(n01)}{(n10)}{blue!92}{node [above, font=\tiny\selectfont, text=black, pos=0.35, yshift=-0.11cm] {$w_1$}}
                \connection{(n02)}{(n10)}{blue!78}{node [midway, below, font=\tiny\selectfont, text=black, yshift=0.03cm] {$w_2$}}

                \connection{($ (n00.west) - (0.5, 0) $)}{(n00)}{blue!65}{}
                \connection{($ (n01.west) - (0.5, 0) $)}{(n01)}{blue!55}{}
                \connection{($ (n02.west) - (0.5, 0) $)}{(n02)}{blue!98}{}

                \connection{(n10)}{($ (n10.east) + (0.5, 0) $)}{blue!82}{}

                \node[font=\footnotesize\selectfont, anchor=north] at (0, -0.25) {
                    $n_{10}=f\left({\color{red}\sum\limits_i w_i \cdot n_{0i}}\right)$
                };
            \fi

            \ifnum#1=1
                \artificialneuron{-0.5}{1}{$n_{00}$}{n00}{red!20!yellow}
                \artificialneuron{-0.5}{0.5}{$n_{01}$}{n01}{red!80!black}
                \artificialneuron{-0.5}{0}{$n_{02}$}{n02}{red!50!black}

                \artificialneuron{0.5}{0.5}{$n_{10}$}{n10}{red}

                \connection{(n10)}{(n00)}{red!20!yellow}{}
                \connection{(n10)}{(n01)}{red!80!black}{}
                \connection{(n10)}{(n02)}{red!50!black}{}

                \connection{(n00)}{($ (n00.west) - (0.5, 0) $)}{red!20!yellow}{}
                \connection{(n01)}{($ (n01.west) - (0.5, 0) $)}{red!80!black}{}
                \connection{(n02)}{($ (n02.west) - (0.5, 0) $)}{red!50!black}{}

                \connection{($ (n10.east) + (0.5, 0) $)}{(n10)}{red}{}

                \node[anchor=east, font=\tiny\selectfont] at ($ (n00.west) - (0.5, 0) $) {$R_0$};
            \fi
