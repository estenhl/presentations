...
\begin{document}
    ...
    \newcommand{\disorderplot}[5]{
        \colorlet{significantcolour}{red}
    ...
    \newcommand{\clinicalplot}[1]{
        \begin{tikzpicture}
            \begin{groupplot}[
                ...
                \disorderplot{ADHD}{#1}{0.5}{0.49}{0.5}
                % \disorderplot{ANX}{#1}{0.5}{0.56}{0.6}
                % \disorderplot{ASD}{#1}{0.5}{0.52}{0.5}
                % \disorderplot{BIP}{#1}{0.49}{0.54}{0.60}
                % \disorderplot{DEM}{#1}{0.5}{0.75}{0.81}
                % \disorderplot{MCI}{#1}{0.5}{0.58}{0.62}
                % \disorderplot{MDD}{#1}{0.49}{0.5}{0.42}
                % \disorderplot{MS}{#1}{0.49}{0.63}{0.87}
                % \disorderplot{SCZ}{#1}{0.5}{0.57}{0.65}
