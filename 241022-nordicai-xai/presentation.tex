    ...
    \sbox{\patients}{
        \begin{tikzpicture}
            \begin{groupplot}[
                ...
                \pgfplotsforeachungrouped \disorder/\idx in {DEM/0, MS/1, MCI/2, SCZ/3, ANX/4, BIP/5, ASD/6, MDD/7, ADHD/8} {
                    \def\xtick{{"-10", "0", "10"}}
                    ...
                    \expandafter\disorderplot\expandafter{\disorder}{\xtick}
                }
            \end{groupplot}
        \end{tikzpicture}
    }
