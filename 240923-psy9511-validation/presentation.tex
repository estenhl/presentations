...
\begin{document}
    ...
    \newcommand{\tabplot}[1]{
        ...
        \begin{tikzpicture}
            \begin{axis}[
                height=4.5cm,
                width=8cm,
                ylabel=\footnotesize{Tolerance-based accuracy},
                ymin=-0.1,
                ymax=1.1,
                ytick={0, 1},
                ...
                \visible<9>{
                    \node[text width=9cm] (losses) at (0, 0) {
                        ...
                        \begin{itemize}
                            ...
                            \item Can also be performance metrics
                            \item Must be differentiable to allow for mathematical optimization
                        \end{itemize}
                    };
                }
                \visible<10>{
                    \node[align=center] at (0, 0) {
                        ...
                        A prediction is considered corrected if it is within a\\
                        predefined margin of error from the true value\\[0.5cm]
                        $\text{accuracy*}(y, \hat{y}) = \begin{cases}
                            0 & \text{if } |y - \hat{y}| < \text{tolerance}\\
                            1 & else
                        \end{cases}$
                    };
                }
    ...
    % \begin{frame}{Model evaluation: Cross-validation} % Summary
    ...
    % \begin{frame}{Model evaluation: Bootstrapping} % Dataset
    %     \begin{tikzpicture}
    %         \node[] at (-4.7, 1) {};
    %         \node[] at (6.5, -5.5) {};
    ...
    % \begin{frame}{Model evaluation: Bootstrapping} % First datapoint
    %     \begin{tikzpicture}
    %         \node[] at (-4.7, 1) {};
    %         \node[] at (6.5, -5.5) {};
    ...
    % \begin{frame}{Model evaluation: Bootstrapping} % Second datapoint
    %     \begin{tikzpicture}
    %         \node[] at (-4.7, 1) {};
    %         \node[] at (6.5, -5.5) {};
    ...
    % \begin{frame}{Model evaluation: Bootstrapping} % Third datapoint
    %     \begin{tikzpicture}
    %         \node[] at (-4.7, 1) {};
    %         \node[] at (6.5, -5.5) {};
    ...
    % \begin{frame}{Model evaluation: Bootstrapping} % Fourth datapoint
    %     \begin{tikzpicture}
    %         \node[] at (-4.7, 1) {};
    %         \node[] at (6.5, -5.5) {};
    ...
    % \begin{frame}{Model evaluation: Bootstrapping} % Full training sample
    %     \begin{tikzpicture}
    %         \node[] at (-4.7, 1) {};
    %         \node[] at (6.5, -5.5) {};
    ...
    % \begin{frame}{Model evaluation: Bootstrapping} % Validation set
    %     \begin{tikzpicture}
    %         \node[] at (-4.7, 1) {};
    %         \node[] at (6.5, -5.5) {};
    ...
    % \begin{frame}{Model evaluation: Bootstrapping} % Full setup
    %     \begin{tikzpicture}
    %         \node[] at (-4.7, 1) {};
    %         \node[] at (6.5, -5.5) {};
    ...
    % \begin{frame}{Model evaluation: Bootstrapping} % First error
    %     \begin{tikzpicture}
    %         \node[] at (-4.7, 1) {};
    %         \node[] at (6.5, -5.5) {};
    ...
    % \begin{frame}{Model evaluation: Bootstrapping} % Second error
    %     \begin{tikzpicture}
    %         \node[] at (-4.7, 1) {};
    %         \node[] at (6.5, -5.5) {};
    ...
    % \begin{frame}{Model evaluation: Bootstrapping} % Third error
    %     \begin{tikzpicture}
    %         \node[] at (-4.7, 1) {};
    %         \node[] at (6.5, -5.5) {};
    ...
    % \begin{frame}{Model evaluation: Bootstrapping} % Summary
    ...
    % \begin{frame}{Model evaluation: Bootstrapping} % Parameter estimate
    %     \centering
    %     \begin{tikzpicture}
    ...
    %         \item We can use the results from cross-validation (or bootstrapping) to produce a distribution of performances (although caution the correlation)
    ...
    %     \begin{itemize}
    %         \item Whenever a choice is made on the basis of performance in a dataset, \textbf{we have to assume the performance achieved by the chosen model is inflated}
