	...
	\begin{frame}{The history of artificial intelligence}
		...
		\begin{tikzpicture}
			...
			\visible<4->{
				...
				\draw[very thick, gray] (-2.9, 2.75)  -- (-2.57, 2.75) {};
			}
			\visible<4-5>{
			...
			\visible<6->{
				...
				\draw[very thick, gray] (-2.57, 2.75)  -- (-1.97, 2.75) {};
			}
			\visible<6>{
			...
			\visible<7->{
				...
				\draw[very thick, gray] (-1.97, 2.75)  -- (-0.12, 2.75) {};
			}
			\visible<7-8>{
			...
			\visible<9->{
				...
				\draw[very thick, gray] (-0.12, 2.75)  -- (0.57, 2.75) {};
			}
			\visible<9-13>{
