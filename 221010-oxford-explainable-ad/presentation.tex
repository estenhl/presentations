...
\begin{document}
	...
	% 		\hline
	% 		progression \textasciitilde age + sex&0.518&51.94\%&0.615&0.687&0.351\\
	% 		\hline
	% 		progression \textasciitilde age + sex + $\hat{y}_{n}$&0.809&74.62\%&0.833&0.706&0.787\\
	% 		\hline
	% 		progression \textasciitilde age + sex + $\hat{y}_{n}$ + $c_{n}$&0.819&76.62\%&0.845&0.736&0.796\\
	% 		\hline
	% 		progression \textasciitilde age + sex + $\hat{y}_{n+1}$ + $c_{n+1}$&0.831&77.23\%&0.839&0.767&0.778\\
	% 		\hline
	% 	\end{tabular}\\
	% 	\vspace{0.4cm}
