...
\begin{document}
    ...
    \begin{frame}{Regression vs. classification}
        ...
        \only<16-17>{
            \begin{tikzpicture}
                \node[draw=black] at (-5.5, 3.5) {};
                \node[draw=black] at (5, -3.5) {};
                \node[] at (0, 0) {
        ...
        \only<20>{
            ...
            \begin{itemize}
                ...
                \item Ordinal regression falls between the two, with disjunct classes that can be ordered.
