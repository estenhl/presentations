...
\begin{document}
	...
	\begin{frame}{AI in neuroimaging}
		...
		\begin{tikzpicture}
			\node[] (img) at (0, 0) {
				\includegraphics[width=1.5cm]{data/mris/slice_3.png}
			};
			\node[minimum width=3.5cm, minimum height=2cm, draw=black, fill=blue!10] (model) at (4, 0) {
				Artificial Intelligence
			};
			\node[] (prediction) at (8, 0) {
				Phenotype
			};

			\draw[dashed, ->] (img) -- (model);
			\draw[dashed, ->] (model) -- (prediction);
		\end{tikzpicture}
		\vfill
	\end{frame}
	...
	\begin{frame}{Potential commercialization}
		\begin{tikzpicture}
			\node[draw=black, label=below:\footnotesize{4MENT}, fill=white] (4ment) at (0, 0) {
				\includegraphics[width=1.5cm]{data/lifescience.jpeg}
			};
			\node[] (norment) at (3, 2.25) {
				\includegraphics[width=1.5cm]{data/norment.png}
			};
			\node[] at (3, 0.5) {
				\includegraphics[width=2cm]{data/ous.png}
			};
			\node[draw=black] (crai) at (3, -0.5) {CRAI};
			\node[draw=black] (mc) at (3.5, -2) {Memory Clinic};
			\node[draw=black] (ms) at (3, -2.75) {Multiple sclerosis};

			\node[draw=black, fill=black] (bio) at (-3, 0) {
				\includegraphics[width=2.5cm]{data/biometrical.png}
			};
			\node[draw=black, inner sep=0pt] (nht) at (-3.75, -1.25) {
				\includegraphics[width=2cm]{data/nht.png}
			};
			\node[draw=black] (aleap) at (-3.75, 1.25) {
				\includegraphics[width=2cm]{data/aleap.png}
			};
			...
			\draw[dotted] (1.5, -0.1) -- (4.8, -0.1) -- (4.8, -3.2) -- (1.5, -3.2) -- (1.5, -0.1);
		\end{tikzpicture}
	\end{frame}
	...
	\begin{frame}{Summary}
		\begin{itemize}
			...
			\item What are the intellectual properties and who owns them?
			\item What is the commercial potential?
			\item Does there exist competitors?
			\item What certification is needed?
