...
\newcommand{\regions}{
    \begin{tikzpicture}
        \begin{axis}[
            ...
            \addplot[only marks, fill=uiogreen, draw=black] table [col sep=comma, x=lrp, y=ale] {data/test_mean.csv};
...
\begin{frame}{Explainable artificial intelligence and clinical neuroimaging}
    Although artificial neural networks very often result in accurate predictions, their opaque nature make it hard to understand how they work.
    \begin{itemize}
        \item Learning shortcuts to solve problems that appear valuable but are really not related to the problem at hand gives rise to "Clever Hans"-predictors.
