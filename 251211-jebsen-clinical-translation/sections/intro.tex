...
\begin{frame}{What is artificial intelligence?}
    \begin{tikzpicture}
        ...
        \only<2-4>{
			\node[circle, fill=uioblue, minimum size=6cm] (ai) at (-3, 0) {};
			...
			\only<3->{
				\node[circle, fill=uioblue!50!uiored, minimum size=4.5cm, anchor=south] (ml) at ($ (ai.south) + (0, 0.05) $) {};
			...
			\only<4->{
				\node[circle, fill=uiored, minimum size=3cm, anchor=south] (dl) at ($ (ai.south) + (0, 0.1) $) {};
        ...
        \only<5->{
            ...
            \neuron[alt=<6>{fill=uiogreen!60}{fill=uiogreen}]{n00}{($ (model.south) + (0, 1.25) + (-2*\hsep, -2*\vsep+0.1) $)}
            \neuron[alt=<6>{fill=uiogreen!40}{fill=uiogreen}]{n01}{($ (n00) + (0, \vsep) $)}
            \neuron[alt=<6>{fill=uiogreen!70!yellow}{fill=uiogreen}]{n02}{($ (n00) + (0, 2*\vsep) $)}
            \neuron[alt=<6>{fill=uiogreen!40!yellow}{fill=uiogreen}]{n03}{($ (n00) + (0, 3*\vsep) $)}
            \neuron[alt=<6>{fill=uiogreen!95}{fill=uiogreen}]{n04}{($ (n00) + (0, 4*\vsep) $)}

            \neuron[alt=<6>{fill=uiogreen!35!yellow}{fill=uiogreen}]{n10}{($ (n00) + (\hsep, 0.5*\vsep) $)}
            \neuron[alt=<6>{fill=uiogreen!55}{fill=uiogreen}]{n11}{($ (n00) + (\hsep, 1.5*\vsep) $)}
            \neuron[alt=<6>{fill=uiogreen!87!yellow}{fill=uiogreen}]{n12}{($ (n00) + (\hsep, 2.5*\vsep) $)}
            \neuron[alt=<6>{fill=uiogreen!92}{fill=uiogreen}]{n13}{($ (n00) + (\hsep, 3.5*\vsep) $)}

            \neuron[alt=<6>{fill=uiogreen!51}{fill=uiogreen}]{n20}{($ (n00) + (2*\hsep, \vsep) $)}
            \neuron[alt=<6>{fill=uiogreen!52!yellow}{fill=uiogreen}]{n21}{($ (n00) + (2*\hsep, 2*\vsep) $)}
            \neuron[alt=<6>{fill=uiogreen!81!yellow}{fill=uiogreen}]{n22}{($ (n00) + (2*\hsep, 3*\vsep) $)}

            \neuron[alt=<6>{fill=uiogreen!90}{fill=uiogreen}]{n30}{($ (n00) + (3*\hsep, 1.5*\vsep) $)}
            \neuron[alt=<6>{fill=uiogreen!41!yellow}{fill=uiogreen}]{n31}{($ (n00) + (3*\hsep, 2.5*\vsep) $)}

            \neuron[alt=<6>{fill=uiogreen!62!yellow}{fill=uiogreen}]{n40}{($ (n00) + (4*\hsep, 2*\vsep) $)}
        ...
        \only<5>{
            \node[circle, draw=black, fill=uiogreen, minimum size=0.5cm] (neuron) at (0, -2.3) {};
