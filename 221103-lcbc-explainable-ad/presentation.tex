...
\begin{document}
	...
	\begin{frame}{Exploring relevance maps in MCI patients} % Groupwise predictions
		\centering
		\vfill
		\begin{tikzpicture}
            \begin{axis}[
                ...
                \addplot[
                    ...
                    x=points,
                    y=improved,
                ] {data/trajectory_distributions/mci.csv};
                ...
                \addplot[
					...
					draw=black
                ] coordinates {(0.105, 4.418/7.838)};\label{trace:imci_dist}
                ...
                \addplot[
                    ...
                    mark options={mark size=3pt},
					draw=black
                ] coordinates {(0.333, 0.592/7.838)};\label{trace:smci_dist}
                ...
                \addplot[
                    ...
                    mark options={mark size=3pt},
					draw=black
                ] coordinates {(0.649, 0.829/7.838)};\label{trace:pmci_dist}

				\node[anchor=north, font=\scriptsize] at (axis cs: 0.5, -0.225) {
					\ref{trace:imci_dist} Improving MCI\hspace*{0.3cm}\ref{trace:smci_dist} Stable MCI\hspace*{0.3cm}\ref{trace:pmci_dist} Progressive MCI
				};
	...
	\begin{frame}{Exploring relevance maps in MCI patients} % Group-level comparison
		...
		\begin{tikzpicture}
			\begin{axis}[
				...
				ymin=0,
				ymax=1,
				xlabel=\footnotesize{Years before diagnosis},
				ylabel=\footnotesize{Group-wise mean prediction},
				...
				\addplot[
					...
					x=year,
					y=declining_mean,
				] {data/yearly_trajectories.csv};\label{trace:pmci}
				...
				\addplot[
					...
					x=year,
					y=stable_mean,
				] {data/yearly_trajectories.csv};\label{trace:smci}

				\node[draw=black, circle, minimum size=5.4pt, fill=gray, inner sep=0pt, anchor=north west] (n25mark) at (axis cs: -8.75, 0.95) {};
				\node[anchor=west, inner sep=0pt] (n25label) at ($ (n25mark.east) + (5, 0) $) {\footnotesize{n=25}};
				\node[draw=black, anchor=west, circle, minimum size=8.5pt, fill=gray, inner sep=0pt] (n100mark) at ($ (n25label.east) + (20, 0) $) {};
				\node[anchor=west, inner sep=0pt] (n100label) at ($ (n100mark.east) + (5, 0) $) {\footnotesize{100}};
				\node[draw=black, anchor=west, circle, minimum size=12pt, fill=gray, inner sep=0pt] (n250mark) at ($ (n100label.east) + (20, 0) $) {};
				\node[anchor=west, inner sep=0pt] (n250label) at ($ (n250mark.east) + (5, 0) $) {\footnotesize{250}};
				\node[anchor=north, font=\scriptsize] at (axis cs: -4.5, -0.25) {
					\ref{trace:smci} Stable MCI\hspace*{0.3cm}\ref{trace:pmci} Progressive MCI
				};
			\end{axis}
		\end{tikzpicture}
		\vfill
	...
	\begin{frame}{Exploring relevance maps in MCI patients} % Group-level comparison
		...
		\begin{tikzpicture}
			\begin{axis}[
				...
				\node[anchor=west, font=\scriptsize\selectfont] at (axis cs: 0, 0.309) {\textcolor{controls-default}{0.309}};

				\addplot[densely dotted, thick] coordinates {
					(-9, 0.656)
					(0, 0.656)
				};
				\node[anchor=west, font=\scriptsize\selectfont] at (axis cs: 0, 0.656) {\textcolor{cases-default}{0.656}};
				...
				\draw[<->] (axis cs: -0.25, 0.309) -- (axis cs: -0.25, 0.656);
				\node[anchor=west, align=left, font=\scriptsize\linespread{0.8}\selectfont] at (axis cs: 0, 0.475) {
					$\beta=0.441$\\
					$p=4.87 \times 10^{-60}$
				};
	...
	\begin{frame}{Exploring relevance maps in MCI patients} % Group-level comparison
		...
		\begin{tikzpicture}
			\begin{axis}[
				...
				\node[anchor=west, font=\scriptsize\selectfont] at (axis cs: 0, 0.45) {\textcolor{controls-default}{0.015}};

				\addplot[densely dotted, thick] coordinates {
					(-9, 0.35)
					(0, 0.8)
				};
				\node[anchor=west, font=\scriptsize\selectfont] at (axis cs: 0, 0.8) {\textcolor{cases-default}{0.062}};
				...
				\draw[<->] (axis cs: -0.25, 0.4375) -- (axis cs: -0.25, 0.7875);
				\node[anchor=west, align=left, font=\scriptsize\linespread{0.8}\selectfont] at (axis cs: 0, 0.625) {
					$\beta=0.047$\\
					$p=6.12 \times 10^{-15}$
				};
				\node[anchor=north, font=\scriptsize] at (axis cs: -4.5, -0.25) {
			...
			\resizebox{\columnwidth}{!}
				{
					\begin{tabular}{|c|c|c|c|c|c|}
						...
						\hline
						age + sex&$0.538\pm0.072$&$53.81\pm7.25$&$0.53\pm0.06$&$0.62\pm0.09$&$0.42\pm0.13$\\
						\hline
						age + sex + $\hat{y}_{n}$&$0.808\pm0.035$&$76.41\pm3.79$&$0.76\pm0.03$&$0.75\pm0.07$&$0.77\pm0.04$\\
						\hline
						age + sex + $\hat{y}^{\ast}_{n+1}$&$0.806\pm0.03$&$75.15\pm3.34$&$0.74\pm0.02$&$0.76\pm0.07$&$0.74\pm0.04$\\
						\hline
						age + sex + $\hat{y}_{n} + c_n$&$0.810\pm0.035$&$75.78\pm3.45$&$0.72\pm0.03$&$0.78\pm0.07$&$0.78\pm0.03$\\
						\hline
						age + sex + $\hat{y}^{\ast}_{n+1} + c^{\ast}_{n+1}$&$\mathbf{0.831\pm0.037}$&$74.52\pm3.08$&$0.72\pm0.03$&$0.78\pm0.07$&$0.70\pm0.05$\\
						\hline
					\end{tabular}
				}
		\end{table}
