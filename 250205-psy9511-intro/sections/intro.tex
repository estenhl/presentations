        ...
        \visible<1-3>{
            \node[text width=10.5cm] at (0, 0) {
                ...
                \begin{itemize}
                    ...
                    \begin{itemize}
                        \item<2-> Often has a focus on prediction
                        \item<2-> Often uses very large datasets
                        \item<2-> More of a focus on computer science and engineering
                        \item<2-> More pragmatic in nature(?)
                    \end{itemize}
                    \item<3> Supervised learning: We know what task we want to solve
                    \item<3> Unsupervised learning: We don't know what task we want to solve (or we don't have the data we need to solve it)
                \end{itemize}
            };
        }
        \visible<4-5,7-8>{
        ...
        \visible<14>{
            \node[text width=10.5cm, align=flush left] at (0, 0) {
                ...
                \begin{itemize}
                    ...
                    \item There is a range of metrics to evaluate model performance
                \end{itemize}
            };
        }
    \end{tikzpicture}
...
\begin{frame}{Introduction: The Bayes Classifier}
    \begin{tikzpicture}
        ...
        \visible<8>{
            \node[text width=10.5cm] at (0, 0) {
                \textbf{Classification can be seen as the task of finding a decision boundary that best separates our classes in a high-dimensional space represented by our predictors}
                \begin{itemize}
