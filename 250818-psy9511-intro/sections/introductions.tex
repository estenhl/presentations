...
\begin{frame}{About the course}
    ...
    \visible<1>{
        \node[text width=10.5cm] at (0, 0) {
            \textbf{Canvas}
            \begin{itemize}
                \item All relevant announcements will be made on \href{https://uio.instructure.com/courses/59550}{Canvas} (e.g. changes to assignments, lectures, interesting reading material etc.).
    ...
    \visible<2>{
        \node[text width=10.5cm] at (0, 0) {
            \textbf{Curriculum}
            \begin{itemize}
                \item The course uses the book "An Introduction to Statistical Learning", available as a PDF \href{https://www.statlearning.com/}{online}.
                \begin{itemize}
                    \item Only some chapters will be used, they are posted on Canvas under each Lecture module.
                    \item Although we won't be relying much on the exercises I \textbf{highly recommend} that you look into them yourselves.
                \end{itemize}
    ...
    \visible<3>{
        \node[text width=10.5cm] at (0, 0) {
            \textbf{Assignments}
            \begin{itemize}
                \item The course has no final exam, but six mandatory assignments you need to pass.
                \begin{itemize}
    ...
    \visible<4>{
        \node[text width=10.5cm] at (0, 0) {
            ...
            \begin{itemize}
                \item You are allowed (and even encouraged) to use generative AI in the assignments, but it is helpful for me when I correct the exercises to know when and where you have used it.
                \item Be critical, you should be able to understand and explain \textbf{all} the code you hand in.
                \item It is your responsibility, both in this course and elsewhere, to ensure you don't break any rules with regards to privacy or copyright. If you are uncertain, \href{https://gpt.uio.no}{GPT UiO} is a relatively safe alternative.
            \end{itemize}
        };
    }
    \visible<5>{
        \node[text width=10.5cm] at (0, 0) {
            \textbf{}
            \begin{itemize}
                \item No mandatory attendance, but I recommend attending.
                \begin{itemize}
                    \item Exercise solutions will be (partially) coded at the beginning of the lectures.
                \end{itemize}
                \item Goal is to demonstrate central parts of the underlying theory in an intuitive manner.
