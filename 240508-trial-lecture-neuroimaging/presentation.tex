...
\begin{document}
    ...
    \begin{frame}{Other structural MRI modalities}
        \centering
        \begin{tikzpicture}
    ...
    \begin{frame}{Diffusion Tensor Imaging (DTI)}
        %https://link.springer.com/article/10.1007/s13760-014-0338-3
        \begin{tikzpicture}
            \only<1>{
                \node[] at (7.6, -3.2) {
                    \usebox{\dmristudies}
    ...
    \section{Future opportunities and challenges}
    \begin{frame}{Multimodality and data fusion}        \centering
        \begin{tikzpicture}
