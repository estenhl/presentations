...
\begin{document}
    ...
    %                 }
    %                 \only<7,8>{
    %                     \node[inner sep=0pt, draw=black] at (2.5, -3.2) {
    %                         \includegraphics[
    %                             height=1.5cm,
    ...
    %                 }
    %                 \only<8>{
    %                     \node[inner sep=0pt, draw=black] at (7.5, -3.2) {
    %                         \includegraphics[
    %                             height=2.5cm,
    %                             trim={0 0 0 9.6cm},
    %                             clip
    ...
    %                 \only<9>{
    %                     \node[inner sep=0pt, draw=black] at (5, -3.2) {
    %                         \includegraphics[width=7cm]{data/dinga_pipeline.jpg}
    %                     };
    %                 }
    %                 \only<10>{
    %                     \node[inner sep=0pt, draw=black] at (5, -3.2) {
    ...
    %             \begin{itemize}
    %                 \item[\textcolor{gray!50}{\textbullet}] \textcolor{gray!50}{\scriptsize{Few prediction studies, mostly for mental disorders with various accuracies (60-100\%) and DEM (80-100\%)}}
        ...
        \begin{tikzpicture}
            ...
            \only<5-13>{
                ...
                \only<11-13>{
                    ...
                    \only<12,13>{
                        \node[inner sep=0pt, draw=black] at (2, -3.25) {
