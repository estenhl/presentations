...
\begin{document}
    ...
    \newsavebox{\msflair}
    \sbox{\msflair}{%
        \disordermodalityplot{MS}{non-T1w sMRI}{t2_studies.csv}{90.54}{1200}{ms}{1200}
    }

    \newsavebox{\pdflair}
    \sbox{\pdflair}{%
        \disordermodalityplot{PD}{non-T1w sMRI}{t2_studies.csv}{90.97}{550}{pd}{470}
    }
                ...
                \only<16-22>{
                    ...
                    \onslide<19->{
                        ...
                        \only<21>{
                            ...
                            \node[] at (7.77, -4.6) {
                                \footnotesize{\textcolor{red}{MAE=$6.0\pm4.8$}}
                            };
                            \node[] at (3.82, -4.6) {
                                \footnotesize{\textcolor{red}{MAE=$7.6\pm6.1$}}
                            };
                        }
                    }
                }
