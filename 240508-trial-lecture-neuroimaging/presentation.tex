...
\begin{document}
    ...
    \begin{frame}[t]{Diffusion MRI}
        ...
        \only<13>{
            ...
            \begin{itemize}
                ...
                \item[\textbullet] {\small Used by Saglam et al. to differentially diagnose SCZ and BP with 80\% accuracy, approaching the threshold for predictive utility.}
            \end{itemize}
            \vfill
        }
    \end{frame}
    ...
    \begin{frame}[t]{Functional Magnetic Resonance Imaging (fMRI)}
        ...
        \only<12>{
            ...
            \begin{itemize}
                ...
                \item[\textbullet] {\small Generally high mean accuracies (80-85\%) but a large spread(60-100\%).}
    ...
    \section{\large{The role of neuroimaging for diagnostic predictions}}
    ...
    \sbox{\accuracyplots}{%
        \begin{tikzpicture}
            ...
            \node[anchor=south] at (axis cs:4, 81.42) {80.47\%};
