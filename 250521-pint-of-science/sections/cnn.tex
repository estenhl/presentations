\newcommand{\mriside}[5]{
    ...
    \draw[fill=black] (input.north west) --
        ($ (input.north west) + (0.5 * #4, 0.5 * #4) $) --
        ($ (input.north east) + (0.5 * #4, 0.5 * #4) $) --
        (input.north east) -- cycle;
    \draw[fill=black] (input.north east) --
        ($ (input.north east) + (0.5 * #4, 0.5 * #4) $) --
        ($ (input.south east) + (0.5 * #4, 0.5 * #4) $) --
        (input.south east) -- cycle;
    \draw[] (input.north west) --
        ($ (input.north west) - (0.5 * #4, 0.5 * #4) $) --
        ($ (input.south west) - (0.5 * #4, 0.5 * #4) $) --
        (input.south west) -- cycle;
    \draw[] (input.north east) --
        ($ (input.north east) - (0.5 * #4, 0.5 * #4) $) --
        ($ (input.south east) - (0.5 * #4, 0.5 * #4) $) --
        (input.south east) -- cycle;
    \draw[] ($ (input.north west) - (0.5 * #4, 0.5 * #4) $) --
        ($ (input.north east) - (0.5 * #4, 0.5 * #4) $);
    \draw[] ($ (input.south west) - (0.5 * #4, 0.5 * #4) $) --
        ($ (input.south east) - (0.5 * #4, 0.5 * #4) $);
}

\newcommand{\inputside}[3]{
    \mriside{#1}{#2}{#3}{0.75cm}{data/mri_sagittal.png}
}

\newcommand{\heatmapside}[3]{
    \mriside{#1}{#2}{#3}{0.75}{data/combined_sagittal.png}
}
...
\newcommand{\convlayer}[8]{
    ...
    \foreach \i in {0,...,\layeriterations}{
        ...
        \convchannel{\x}{\layery}{\layernodedepth}{\layernodesize}{\layernodecount}{\layercolour}{\islast}{\colour}
    }
}
...
\newcommand{\cnn}[7]{
    ...
    \begin{tikzpicture}
        \convlayer{#1 - 0.06 + 0.4}{#2 + 2.5 * #4}{#3}{#4}{12}{3}{\modelcolour}{#7}
        \cnnarrow{(#1 + 0.95, #2)}{(#1+2.2, #2)}{#5}

        \convlayer{#1 + 1.44 + 0.4}{#2 + 1.5 * #4}{#3}{#4}{8}{5}{\modelcolour}{#7}
        \cnnarrow{(#1 + 2.43, #2)}{(#1+3.5, #2)}{#5}

        \convlayer{#1 + 2.77 + 0.4}{#2 + 0.5 * #4}{#3}{#4}{4}{7}{\modelcolour}{#7}
...
\newcommand{\lrp}[4]{
    ...
    \begin{tikzpicture}
        ...
        \lrparrow{(#1+2.2, #2)}{(#1 + 0.95, #2)}{red}

        \lrplayer{#1 + 1.44 + 0.4}{#2 + 1.5 * #4}{#3}{#4}{8}{5}{black}
        \lrparrow{(#1+3.5, #2)}{(#1 + 2.43, #2)}{red}

        \lrplayer{#1 + 2.77 + 0.4}{#2 + 0.5 * #4}{#3}{#4}{4}{7}{black}
        \lrparrow{(#1+5, #2)}{(#1 + 3.75, #2)}{red}

        \lrplayer{#1 + 3.93 + 0.4}{#2 + 0}{#3}{#4}{2}{9}{red}
