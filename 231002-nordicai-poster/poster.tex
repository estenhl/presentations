    ...
    \begin{block}{Results}
        \begin{columns}[t]
                    ...
                    \begin{figure}
                        ...
                        \caption{%
                            \parbox{\textwidth}{\justify%
                                \textbf{Figure~\thefigure:}~ Three axial brain slices, showing the concordance between the average heatmap from LRP and the statistical reference map from GingerALE.
                            }
                        }\label{fig:overlap}
                    \end{figure}
                    \vspace{0.8cm}
            ...
            \begin{column}{.45\textwidth}
                \parbox[t]{\textwidth}{\justify
                \begin{itemize}[leftmargin=0em,labelindent=\parindent]
                    \item[\textbullet] In the MCI sample, we predicted
                    progression to dementia within 5 years with an AUC of 0.9.
...
\begin{columns}
    ...
    \begin{column}{.3\textwidth}
        \begin{block}{Conclusion}
            ...
            characterize the manifestation of dementia in individual patients. When
            employing the pipeline in a sample of patients with MCI,
            information derived from it allowed us to predict progression of the disease,
            and revealed associations between heterogeneity in the brain and specific cognitive impairments.
