...
\title{En introduksjon til kunstig intelligens og dets rolle i medisinsk forskning}
...
\begin{document}
    ...
    \begin{frame}{Oversikt}
        \begin{enumerate}
            \item Historikk
            \item Hva er egentlig kunstig intelligens (og maskinlæring)?
            \item Kunstig intelligens i hjerneforskning
            \item Kunstig intelligens i kreftforskning
        \end{enumerate}
    \end{frame}
	...
	\begin{frame}[t]{Historikk} % Turing test
		\begin{tikzpicture}
			\node[] at (0, 0) {};
			\node[] at (10.5, -7.5) {};
    ...
    \begin{frame}[t]{Historikk} % Dartmouth
		\begin{tikzpicture}
			\node[] at (0, 0) {};
			\node[] at (10.5, -7.5) {};

			\draw[very thick, passivehistory] (0.5, -1)  -- (2.35, -1) {};
    ...
    \begin{frame}[t]{Historikk} % Perceptron: Neuron
		\begin{tikzpicture}
			\node[] at (0, 0) {};
			\node[] at (10.5, -7.5) {};

			\draw[very thick, passivehistory] (0.5, -1)  -- (2.68, -1) {};
    ...
    \begin{frame}[t]{Historikk} % Perceptron
		\begin{tikzpicture}
			\node[] at (0, 0) {};
			\node[] at (10.5, -7.5) {};
    ...
    \begin{frame}[t]{Historikk} % Eliza
		\begin{tikzpicture}
			\node[] at (0, 0) {};
			\node[] at (10.5, -7.5) {};

			\draw[very thick, passivehistory] (0.5, -1)  -- (3.28, -1) {};
    ...
    \begin{frame}[t]{Historikk} % Expert systems: Overview
		\begin{tikzpicture}
			\node[] at (0, 0) {};
			\node[] at (10.5, -7.5) {};

			\draw[very thick, passivehistory] (0.5, -1)  -- (5.13, -1) {};
			...
			\node[
				...
				inner sep=0pt,
				align=center
			] at (5.13, -1.375) {Ekspertsystemer\\(1980s)};
    ...
    \begin{frame}[t]{Historikk} % Nevrale nettverk: Perceptron
		\begin{tikzpicture}
			\node[] at (0, 0) {};
			\node[] at (10.5, -7.5) {};

			\draw[very thick, passivehistory] (0.5, -1)  -- (5.82, -1) {};
			...
			\node[
				...
				inner sep=0pt,
				align=center
			] at (5.82, -0.87) {Nevrale nettverk\\(1986)};
	...
	\begin{frame}[t]{Historikk} % Nevrale nettverk: Neural net
		\begin{tikzpicture}
			\node[] at (0, 0) {};
			\node[] at (10.5, -7.5) {};
    ...
    \begin{frame}[t]{Historikk} % Deep blue
		\begin{tikzpicture}
			\node[] at (0, 0) {};
			\node[] at (10.5, -7.5) {};

			\draw[very thick, passivehistory] (0.5, -1)  -- (7.1, -1) {};
			...
			\node[anchor=north west, align=left] at ($ (img.north east)  + (0.1, 0) $) {
				...
				\bullet\hspace{0.1cm}En kombinasjon av maskinlæring\\og preprogrammert kunnskap fra\\sjakkeksperter.
			};
		\end{tikzpicture}
	\end{frame}

    \begin{frame}[t]{Historikk} %DL (image classification)
		\begin{tikzpicture}
			\node[] at (0, 0) {};
			\node[] at (10.5, -7.5) {};

			\draw[very thick, passivehistory] (0.5, -1)  -- (8.84, -1) {};
	...
	\begin{frame}[t]{Historikk} %DL (imagenet)
		\begin{tikzpicture}
			\node[] at (0, 0) {};
			\node[] at (10.5, -7.5) {};
    ...
    \begin{frame}[t]{Historikk} %DL (old)
	...
	\begin{frame}[t]{Historikk} %DL (CNN)
	...
	\begin{frame}[t]{Historikk} %DL (2020)
	...
	\begin{frame}[t]{Historikk} %DL (human)
		...
		\sbox{\imagenethuman}{%
			\begin{tikzpicture}
				\begin{axis}[
					...
					\addplot[dashed, violet] coordinates {
						(2009, 5.1)
						(2021, 5.1)
					};

					\node[anchor=south east] at (axis cs: 2021, 5.1) {
						\textcolor{violet}{\small{Menneske}}
					};
				\end{axis}
			\end{tikzpicture}
		}
    ...
    \begin{frame}[t]{Historikk} %ChatGPT
		\begin{tikzpicture}
			\node[] at (0, 0) {};
			\node[] at (10.5, -7.5) {};

			\draw[very thick, passivehistory] (0.5, -1)  -- (10, -1) {};
    ...
    \begin{frame}{AI i hjerneforskning: Presisjonsdiagnostikk} % Forgets
        \centering
        \begin{tikzpicture}
            \node[inner sep=0pt, draw=green, very thick] (c0) at (-1.6, 0) {
                \includegraphics[width=3cm]{data/control_0.png}
