...
\begin{document}
	...
	\begin{frame}{Overview of progress}
		...
		\begin{itemize}
			...
			\item Paper 2: Published Molecular Psychiatry 10.05.23
	...
	\begin{frame}{Introduction} % GLM pipeline
		\centering
		\vfill
		\begin{tikzpicture}
	...
	\begin{frame}{Introduction} % GLM
		...
		\begin{tikzpicture}
			...
			\draw[->] (in1) -| ($ (out) - (3, -0.05) $) -- ($ (out.west) + (0, 0.05) $);
			\draw[->] (in2) -| ($ (out) - (3, 0.05) $) -- ($ (out.west) + (0, -0.05) $);
