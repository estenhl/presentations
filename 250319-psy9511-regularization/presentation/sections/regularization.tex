        ...
        \begin{tikzpicture}
            ...
            \only<1>{
                \node[align=left, text width=10.5cm] at (0, 0) {
                    \textbf{Regularization}: A set of techniques to explicitly reduce the complexity of our models to reduce overfitting.
                    \begin{itemize}
                        \item Encouraging our models to learn broader and more general patterns in the training data instead of memorizing it
                    \end{itemize}
                };
            }
