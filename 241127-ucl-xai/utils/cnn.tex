...
\newcommand{\cnnbox}[1]{
    \begin{tikzpicture}
        ...
        \fi
        \ifnum#1>5
            \draw[thick, dashed] (0.22, 1.43) --
                    (5.13, 1.43) --
                    (5.13, -1.42) --
                    (0.22, -1.42) -- cycle;
            \node[anchor=south, text depth=0, font=\scriptsize\selectfont] at (2.675, 1.43) {
...
\newsavebox{\lrppatient}
\sbox{\lrppatient}{
    \cnnbox{6}
}
\newsavebox{\cnnpatient}
\sbox{\cnnpatient}{
    \cnnbox{7}
}
