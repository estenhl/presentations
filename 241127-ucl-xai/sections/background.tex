...
\begin{frame}{Background: Predictive clinical neuroscience}
    \begin{tikzpicture}
        ...
        \visible<2>{
            ...
            \node[label=below:\small{Side}] (side) at (-3.35, 1.5) {
                \includegraphics[height=2cm]{data/mri_sagittal.png}
            };
...
\begin{frame}{Background: Conceptualization}
    \begin{tikzpicture}
        \node[] at (-5.25, 3.5) {};
        \node[] at (5.25, -3.5) {};

        \visible<1-4,6-8>{
            \node[inner sep=0pt] (input) at (-3.375, 1.5) {
                \includegraphics[height=2cm]{data/mri_sagittal.png}
            };
        ...
        \visible<3-4,6-8>{
            \node[inner sep=2pt, fill=black] (v0) at (-4.5, -3) {};
            \node[inner sep=2pt, fill=black!20] (v1) at (-4.25, -3) {};
            \node[inner sep=2pt, fill=black!40] (v2) at (-4, -3) {};
            \node[inner sep=2pt, fill=black!70] (v3) at (-3.75, -3) {};
            \node[inner sep=2pt, fill=black!72] (v4) at (-3.5, -3) {};
            \node[inner sep=2pt, fill=black] (v5) at (-3.25, -3) {};
            \node[inner sep=2pt, fill=black!85] (v6) at (-3, -3) {};
            \node[inner sep=2pt, fill=black!92] (v7) at (-2.75, -3) {};
            \node[inner sep=2pt, fill=black!65] (v8) at (-2.5, -3) {};
            \node[inner sep=2pt, fill=black!81] (v9) at (-2.25, -3) {};
        }
        \visible<4,6-8>{
            \node[circle, inner sep=4pt, draw=black] (t) at (-3.375, -0.75) {};
            \node[] (p) at (3.7, -0.75) {
                Schizophrenia
            };
            \draw[stealth-stealth, line width=3pt, gray] (t) -- (p);
        }
        \visible<4>{
            \draw[-stealth] (v0) -- (t);
            \draw[-stealth] (v1) -- (t);
        ...
        \visible<5>{
            \node[text width=9.5cm, align=center] at (0, 0) {
                \textit{"Despite considerable heterogeneity at the}\\
                \textit{regional level, deviations were often coupled}\\
                \textit{to common functional circuits and networks"}
            };
            \node[anchor=south, text width=9.5cm, font=\tiny, align=center] at (0, -3.75) {
                ...
                Segal, A. et al., \textit{Nature Neuroscience} (2023)
            };
        }
        \visible<6-8>{
            \node[circle, inner sep=3pt, draw=black] (a0) at (-4.125, -1.875) {};
            \node[circle, inner sep=3pt, draw=black] (a1) at (-3.75, -1.875) {};
            \node[circle, inner sep=3pt, draw=black] (a2) at (-3.375, -1.875) {};
            \node[circle, inner sep=3pt, draw=black] (a3) at (-3, -1.875) {};
            \node[circle, inner sep=3pt, draw=black] (a4) at (-2.625, -1.875) {};

            \foreach \j in {0, ..., 4} {
                \foreach \i in {0, ..., 9} {
                    \draw[-stealth] (v\i) -- (a\j);
                }
                \draw[-stealth] (a\j) -- (t);
            }
        }
        \visible<7-8>{
            \node[draw=red, very thick, minimum width=1.9cm, minimum height=0.4cm, inner sep=0pt] (r2) at (-3.375, -1.875) {};
        }
        \visible<8>{
            \node[circle, inner sep=3pt, draw=black] (s0) at (4.45, -1.875) {};
            \node[circle, inner sep=3pt, draw=black] (s1) at (4.075, -1.875) {};
            \node[circle, inner sep=3pt, draw=black] (s2) at (3.7, -1.875) {};
            \node[circle, inner sep=3pt, draw=black] (s3) at (3.325, -1.875) {};
            \node[circle, inner sep=3pt, draw=black] (s4) at (2.95, -1.875) {};

            \foreach \i in {0, ..., 4} {
                \draw[-stealth] (s\i) -- (p);
            }

            \node[draw=red, very thick, minimum width=1.9cm, minimum height=0.4cm, inner sep=0pt] (r1) at (3.7, -1.875) {};

            \draw[stealth-stealth, very thick, red] (r1) -- (r2);
        }
        \visible<9>{
            \node[text width=9.5cm, align=center] at (0, 0) {
                \textit{"We propose explanation space as a powerful}\\
                \textit{embedding to facilitate detection of latent}\\
                \textit{disease subtypes, [...]. Transforming from}\\
                \textit{feature space to explanation space should not be seen in competition to dimensionality reduction, but rather as a complimentary processing step"}
            };
            \node[anchor=south, text width=9.5cm, font=\tiny, align=center] at (0, -3.75) {
                Inferring disease subtypes from clusters in explanation space\\
                Schulz, MA. et al., \textit{Scientific Reports} (2020)
            };
        }
        \visible<10>{
            \node[inner sep=0pt, draw=black, label=above:\footnotesize{Input}] at (-3, 0) {
                \includegraphics[width=2.5cm, height=2.5cm]{data/bird.png}
            };
            \node[inner sep=0pt, draw=black, label=above:\footnotesize{Explanation}] at (0, 0) {
                \includegraphics[width=2.5cm, height=2.5cm]{data/gradientsxinput.png}
            };
            \node[inner sep=0pt, draw=black, label=above:\footnotesize{Edge detector}] at (3, 0) {
                \includegraphics[width=2.5cm, height=2.5cm]{data/edgedetector.png}
            };
            \node[anchor=south, text width=9.5cm, font=\tiny, align=center] at (0, -3.75) {
                Sanity Checks for Saliency Maps\\
                Adebayo, J. et al., \textit{preprint at arXiv} (2018)
            };
        }
    \end{tikzpicture}
\end{frame}
