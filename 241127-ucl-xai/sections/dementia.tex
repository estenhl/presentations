\section{Explainability and dementia}
...
\begin{frame}[t]{Explainability and dementia: Dataset}
    \centering
    \vfill
...
\sbox{\dementiapredictions}{
    ...
    \begin{tikzpicture}
        ...
        \node[anchor=south west] at ($ (distributions.south east) + (0,0.28) $) {\footnotesize{Controls}};
        \node[anchor=south west] at ($ (distributions.south east) + (0,0.0) $) {\footnotesize{Cases}};
    \end{tikzpicture}
}

\begin{frame}[t]{Explainability and dementia: Modelling}
    ...
    \begin{tikzpicture}
        ...
        \visible<6>{
            \node[minimum height=\datasetheight, minimum width=\datasetwidth, fill=train, draw=black, anchor=west] (d10) at (-5, 1.25) {};
            \node[minimum height=\datasetheight, minimum width=\datasetwidth, fill=train, draw=black, anchor=west] (d11) at (d10.east) {};
            \node[minimum height=\datasetheight, minimum width=\datasetwidth, fill=val, draw=black, anchor=west] (d12) at (d11.east) {};
            \node[minimum height=\datasetheight, minimum width=\datasetwidth, fill=test, draw=black, anchor=west] (d13) at (d12.east) {};
            \node[minimum height=\datasetheight, minimum width=\datasetwidth, fill=train, draw=black, anchor=west] (d14) at (d13.east) {};

            \node[minimum height=\datasetheight, minimum width=\datasetwidth, fill=train, draw=black, anchor=west] (d20) at (-5, 0) {};
            \node[minimum height=\datasetheight, minimum width=\datasetwidth, fill=val, draw=black, anchor=west] (d21) at (d20.east) {};
            \node[minimum height=\datasetheight, minimum width=\datasetwidth, fill=test, draw=black, anchor=west] (d22) at (d21.east) {};
            \node[minimum height=\datasetheight, minimum width=\datasetwidth, fill=train, draw=black, anchor=west] (d23) at (d22.east) {};
            \node[minimum height=\datasetheight, minimum width=\datasetwidth, fill=train, draw=black, anchor=west] (d24) at (d23.east) {};

            \node[minimum height=\datasetheight, minimum width=\datasetwidth, fill=val, draw=black, anchor=west] (d30) at (-5, -1.25) {};
            \node[minimum height=\datasetheight, minimum width=\datasetwidth, fill=test, draw=black, anchor=west] (d31) at (d30.east) {};
            \node[minimum height=\datasetheight, minimum width=\datasetwidth, fill=train, draw=black, anchor=west] (d32) at (d31.east) {};
            \node[minimum height=\datasetheight, minimum width=\datasetwidth, fill=train, draw=black, anchor=west] (d33) at (d32.east) {};
            \node[minimum height=\datasetheight, minimum width=\datasetwidth, fill=train, draw=black, anchor=west] (d34) at (d33.east) {};

            \node[minimum height=\datasetheight, minimum width=\datasetwidth, fill=test, draw=black, anchor=west] (d40) at (-5, -2.5) {};
            \node[minimum height=\datasetheight, minimum width=\datasetwidth, fill=train, draw=black, anchor=west] (d41) at (d40.east) {};
            \node[minimum height=\datasetheight, minimum width=\datasetwidth, fill=train, draw=black, anchor=west] (d42) at (d41.east) {};
            \node[minimum height=\datasetheight, minimum width=\datasetwidth, fill=train, draw=black, anchor=west] (d43) at (d42.east) {};
            \node[minimum height=\datasetheight, minimum width=\datasetwidth, fill=val, draw=black, anchor=west] (d44) at (d43.east) {};
        }
        \visible<7>{
        ...
        \visible<9>{
            \node[draw=black, dashed, align=center, font=\scriptsize] (generation) at ($ (d04.south) - (0, 1) $) {
                Heatmap\\generation
            };
...
\sbox{\dicebox}{
    ...
    \begin{tikzpicture}
        \begin{axis}[
            ...
            \addplot[very thick,draw=blue] table [col sep=comma, x=thresholds, y=test] {data/dice.csv};\label{trace:dementia}
            \addplot[very thick,draw=green] table [col sep=comma, x=thresholds, y=sex] {data/dice.csv};\label{trace:sex}
            \addplot[very thick,draw=gray] table [col sep=comma, x=thresholds, y=randomized_weights] {data/dice.csv};\label{trace:weights}
            \addplot[very thick,draw=orange] table [col sep=comma, x=thresholds, y=randomized_images] {data/dice.csv};\label{trace:images}
            \addplot[only marks, fill=blue, draw=blue, mark size=3] coordinates {
                (0.5, 0.6131)
                (0.7, 0.5296)
                (0.9, 0.4291)
            };
...
\begin{frame}{Explainability and dementia: Validation}
    \begin{tikzpicture}
        \node[draw=black] at (-5.25, 3.5) {};
        \node[draw=black] at (5.25, -3.5) {};
...
\sbox{\mcimixed}{
    ...
    \begin{tikzpicture}
        \begin{axis}[
            ...
            \addplot[\linestyle,controls-default] coordinates {
                (-9, 0.258)
                (0, 0.258)
            };
            \addplot[\linestyle,cases-default] coordinates {
                (-9, 0.656)
                (0, 0.656)
            };
            \addplot[
            ...
            \node[anchor=west, align=left] at (axis cs: \diffx, 0.465) {\tiny{$\beta=0.44$}};
            \node[anchor=west, align=left] at (axis cs: \diffx, 0.435) {\tiny{$p=4.87 \times 10^{-60}$}};
            \draw[<->] (axis cs: \diffx, 0.258) -- (axis cs: \diffx, 0.656);
...
\begin{frame}{Explainability and dementia: Application}
    \begin{tikzpicture}
        \node[draw=black] at (-5.25, 3.5) {};
        \node[draw=black] at (5.25, -3.5) {};
