...
\begin{document}
	...
	% 				\newcommand{\patientlocation}[1]{($ (1, -1.5) + ####1 $)}
	% 				\newcommand{\controllocation}[1]{($ (1, -2.9) + ####1 $)}
	% 				\newcommand{\modellocation}[1]{($ (0.5 * \plotwidth, -2.2) + ####1 $)}


	% 				\node[] at \patientlocation{(0, 0.7)} {\scriptsize{Patients}};
	% 				\node[] at \controllocation{(0, -0.7)} {\scriptsize{Controls}};
	...
	% 				\node[] (loss) at (1+2*4.85, -2.2) {\scriptsize{$\mathrm{logloss}(y, \hat{y})$}};
	...
	% 					-\outerarrow,
	% 					line width=0.1cm
	% 				] \patientlocation{(0.7, 0)} to [out=0,in=180] (n00) {};
	% 				\draw[
	% 					color=outercolor,
	% 					-\outerarrow,
	% 					line width=0.1cm
	% 				] \controllocation{(0.7, 0)} to [out=0,in=180] (n00) {};
	% 				\draw[
	% 					color=outercolor,
	...
	% 		\fbox{
	% 			\begin{tikzpicture}
	% 				\node[anchor=north west] at (0, 0) {\footnotesize{2. Apply model and LRP for individual-level predictions and relevance maps}};
	% 				\node[anchor=north east] at (\plotwidth, 0) {};
	...
	% 					{\transparent{\mrialpha}\includegraphics[height=0.5cm]{data/mris/slice_8.png}}
	% 				};
	% 				\node[inner sep=0pt, outer sep=0pt] (input) at \mrilocation{(0, -0.5*\mrivsep)} {
	% 					\includegraphics[height=0.5cm]{data/mris/slice_8.png}
	% 				};
	% 				\node[] at \mrilocation{(1 * \mrihsep, -0.5*\mrivsep)} {
	% 					{\transparent{\mrialpha}\includegraphics[height=0.5cm]{data/mris/slice_8.png}}
	...
	% 				\node[] at ($ (map.south) - (0, 0.2) $) {\scriptsize{Relevance}};
	% 				\node[] at ($ (map.south) - (0, 0.55) $) {\scriptsize{map}};
	...
	% 					-\outerarrow,
	% 					line width=0.1cm
	% 				] \patientlocation{(0.65, 0)} to (mean);
	...
	% 				\node[] at \patientlocation{(0, 0.7)} {\scriptsize{MCI}};
	...
	% 					-\outerarrow,
	% 					line width=0.1cm
	% 				] \patientlocation{(0.65, 0)} to (0.5 * \plotwidth - 1, -1.7);
	...
	% \begin{frame}{Case-control predictions} % Diagnostic criteria
	% 	\centering
	% 	\vfill
	%     \begin{tabular}{|c|c|c|}
    %         \hline
	...
	% 		\multirow{2}*{\scriptsize{####1}}&
	% 		\multirow{2}*{\scriptsize{####2}}&
	% 		\multirow{2}*{\scriptsize{####3}}&
	% 		\multirow{2}*{\scriptsize{####4}}&
	% 		\scriptsize{####5}&\scriptsize{####6}\\
	% 		\cline{5-6}
	% 		&&&&\scriptsize{####7}&\scriptsize{####8}\\
	% 		\hline
	% 	}
	...
	% 			\hline
	% 			\textbf{\scriptsize{Sites}}&\textbf{\scriptsize{Size}}&\textbf{\scriptsize{AUC}}&\textbf{\scriptsize{Accuracy}}&\multicolumn{2}{c|}{\textbf{\scriptsize{Confusion Matrix}}}\\
	% 			\hline
	...
	% \begin{frame}{Generating relevance maps}
	% 	\vfill
	% 	\centering
	% 	\begin{tikzpicture}
